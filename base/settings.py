...
SECRET_KEY = 'django-insecure-v2-(f2l8=m9a(a2z2^uz&w#-sw%y-xy*le(l=yox_z6f69q&qm'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'operaciones.context_processors.carrito_context',
            ],
        },
    },
]
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'avecbm2024@gmail.com'
EMAIL_HOST_PASSWORD = 'vgum ugmo qubb mwbn'
EMAIL_USE_TLS = True
